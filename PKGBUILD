...
arch=("x86_64")
url="https://github.com/zhitrend/cursor-vip"
license=("MIT")
depends=("python" "cursor-bin")
makedepends=("git" "python" "pyinstaller" "uv")
provides=("cursor-free-vip")
source=("cursor-free-vip::git+https://github.com/zhitrend/cursor-vip.git" "https://raw.githubusercontent.com/zhitrend/cursor-vip/main/LICENSE")
